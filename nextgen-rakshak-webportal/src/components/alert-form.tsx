      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row">
          <label
            htmlFor="photo"
            className={cn(
              "flex h-32 w-32 shrink-0 cursor-pointer items-center justify-center overflow-hidden rounded-xl border-2 border-dashed text-muted-foreground transition-colors hover:border-primary/40 hover:bg-muted/60",
              preview ? "border-solid border-border" : "border-border bg-muted/40"
            )}
          >
            {preview ? (
